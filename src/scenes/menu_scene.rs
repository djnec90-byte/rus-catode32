...
const MINIGAMES: &[MenuItem] = &[
    ...
    MenuItem { label: "Memory",    icon: Some(icons::MEMORY),     submenu: None, action: Some(MenuAction::Scene(SceneId::Stub("memory"))),    confirm: None },
...
const DEBUG: &[MenuItem] = &[
    ...
    MenuItem { label: "Behaviors",   icon: Some(icons::CAT),    submenu: None,             action: Some(MenuAction::Scene(SceneId::Stub("debug_behaviors"))),      confirm: None },
    ...
    MenuItem { label: "Time Speed",  icon: Some(icons::WRENCH), submenu: None,             action: Some(MenuAction::Scene(SceneId::Stub("time_settings"))),        confirm: None },
