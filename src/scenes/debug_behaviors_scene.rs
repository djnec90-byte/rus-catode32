...
impl Entry {
    fn label(self) -> &'static str {
        match self {
            ...
            Entry::Napping => "Napping",
            Entry::Stretching => "Stretching",
            Entry::Kneading => "Kneading",
            Entry::Lounging => "Lounging",
            Entry::Investigating => "Investigating",
            Entry::Startled => "Startled",
            Entry::Observing => "Observing",
            Entry::Chattering => "Chattering",
            Entry::Zoomies => "Zoomies",
            Entry::Vocalizing => "Vocalizing",
            Entry::SelfGrooming => "Self Grooming",
            Entry::BeingGroomed => "Being Groomed",
            Entry::Hunting => "Hunting",
            Entry::GiftFish => "Gift (fish)",
            Entry::GiftMouse => "Gift (mouse)",
            Entry::Pacing => "Pacing",
            Entry::Meandering => "Meandering",
            Entry::Sulking => "Sulking",
            Entry::Mischief => "Mischief",
            Entry::Hiding => "Hiding",
            ...
            Entry::HearingExclaim => "Hearing (exclaim)",
            Entry::HearingHeart => "Hearing (heart)",
            Entry::HearingNote => "Hearing (note)",
