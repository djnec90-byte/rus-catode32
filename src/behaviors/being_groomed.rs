...
impl Behavior for BeingGroomedBehavior {
    ...
    fn enter(&mut self, ctx: &mut GameContext, _: &mut Character) {
        ...
        // Python: random.randint(10, 30) — inclusive.
        ...
        if self.rejecting {
            // Python skips straight to "enjoying" so the cat just lays there
    ...
    fn apply_completion_bonus(&self, ctx: &mut GameContext, progress: f32) {
        ...
        // Location bonus (matches apply_location_bonus in Python).
