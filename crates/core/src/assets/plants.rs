...
impl PlantStage {
    ...
    pub fn label(self) -> &'static str {
        match self {
            PlantStage::EmptyPot => t!("Empty pot"),
            PlantStage::Seedling => t!("Seedling"),
            PlantStage::SeedlingWilted => t!("Wilting seedling"),
            PlantStage::SeedlingDead => t!("Dead seedling"),
            PlantStage::Young => t!("Young"),
            PlantStage::YoungWilted => t!("Wilting"),
            PlantStage::YoungDead => t!("Dead"),
            PlantStage::Growing => t!("Growing"),
            PlantStage::GrowingWilted => t!("Wilting"),
            PlantStage::GrowingDead => t!("Dead"),
            PlantStage::Mature => t!("Mature"),
            PlantStage::MatureWilted => t!("Wilting"),
            PlantStage::MatureDead => t!("Dead"),
            PlantStage::Thriving => t!("Thriving"),
            PlantStage::ThrivingWilted => t!("Wilting"),
            PlantStage::ThrivingDead => t!("Dead"),
            PlantStage::Dead => t!("Dead"),
            PlantStage::Dormant => t!("Dormant"),
        }
    }
}
